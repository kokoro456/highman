      ...
      <div className="flex items-center gap-2 md:gap-3 ml-2 md:ml-4">
        ...
        <div className="relative" ref={notifRef}>
          <button
            ...
            className="relative flex h-9 w-9 items-center justify-center rounded-xl hover:bg-zinc-100 transition-all duration-200 active:scale-95"
          >
          ...
          {showNotifications && (
            <div className="absolute right-0 top-full mt-2 z-50 w-80 md:w-96 rounded-xl bg-white ring-1 ring-zinc-200/50 shadow-soft-xl animate-fade-in overflow-hidden">
              <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-100">
                <p className="text-sm font-semibold text-zinc-800">알림</p>
                {unreadCount > 0 && (
                  <button
